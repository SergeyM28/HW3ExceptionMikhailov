...
public class Main {
    public static void main(String[] args) {
        ...
        String temp = r.input(); //считывает данные из консоли
        p.parse(temp); //Попытка распарсить ввод
        System.out.println(p); //для информации вывожу в консоль результат работы Parser

        Writer w = new Writer(p);
        w.createFile(); //Создает файл, если фамилия уникальна
        w.writeFile(); //Пишет в файл
    }
}